/* Display test for 2.4" 320x240 TFT display ST7789, shield Arduino Uno
 * 
 * Board:   Arduino Uno rev3, original                            https://www.laskakit.cz/en/arduino-uno-rev3--original/
 * Display: 2.4" 320x240 TFT display ST7789, shield Arduino Uno   https://www.laskakit.cz/en/320x240-barevny-lcd-tft-displej-2-4--ssd1289--shield-arduino/
 * 
 * Use ID 0x7789 for this display
 *
 * Email:podpora@laskakit.cz
 * Web:laskakit.cz
 */

// Requires MCUFRIEND_kbv Library hhttps://github.com/prenticedavid/MCUFRIEND_kbv
