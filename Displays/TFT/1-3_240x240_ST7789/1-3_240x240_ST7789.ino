 ...
 * Display: 1.3" 240x240 IPS ST7789 Display https://www.laskakit.cz/1-3--240x240-tft-ips-barevny-displej-st7789--spi/
 * 
...
//#define ESP32DEVKit     //for version v2.6 and earlier
#define ESP32S3DEVKit   //for version v3.0 and above

#ifdef ESP32DEVKit
  #define TFT_MOSI  23
  #define TFT_SCLK  18
  #define TFT_DC    15    // CS pin is used on µŠup SPI connector
  #define TFT_RST   12    // SDO pin is used on µŠup SPI connector
  #define POWER 2
#else ESP32S3DEVKit
  #define TFT_MOSI  11
  #define TFT_SCLK  12
  #define TFT_CS    40
  #define TFT_DC    10    // CS pin is used on µŠup SPI connector
  #define TFT_RST   13    // SDO pin is used on µŠup SPI connector
  #define POWER     47
#endif
...
void setup(void) {
  ...
  digitalWrite(POWER, HIGH);   // turn the uSUP on (HIGH is the voltage level)
