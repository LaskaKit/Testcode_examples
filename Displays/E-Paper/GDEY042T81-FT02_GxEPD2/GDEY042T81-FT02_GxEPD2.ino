...
/* Display test for Good Display GDEY042T81-FT02
 * example from GxEPD2 library is used
 * 
 * Board:   LaskaKit ESPink ESP32 e-Paper   https://www.laskakit.cz/laskakit-espink-42-esp32-e-paper-pcb-antenna/
 * Display: Good Display GDEY042T81-FT02 https://www.laskakit.cz/good-display-gdey042t81-ft02-4-2--400x300-epaper-displej-dotykovy-s-podsvicenim/         
 * 
...
#define PIN_ON 2
#define EPAPER_LED          26      // TFT backlight pin
#define EPAPER_LED_PWM      100     // dutyCycle 0-255 last minimum was 15

GxEPD2_BW<GxEPD2_420_GDEY042T91, GxEPD2_420_GDEY042T91::HEIGHT> display(GxEPD2_420_GDEY042T91(/*CS=D8*/ SS, /*DC=D3*/ 17, /*RST=D4*/ 16, /*BUSY=D2*/ 4)); //GDEY042T81-FT02, GDEY042T91, 400x300, SSD1683 (no inking)
...
// turn on power to display
  ...
  digitalWrite(PIN_ON, HIGH);   // turn the LED on (HIGH is the voltage level)
  Serial.println("Display power ON");
  delay(1000);   
  
// configure backlight LED PWM functionalitites
  ledcSetup(1, 5000, 8);              // ledChannel, freq, resolution
  ledcAttachPin(EPAPER_LED, 1);          // ledPin, ledChannel
  ...
  ledcWrite(1, EPAPER_LED_PWM);          // Turn on backlight LED,  dutyCycle 0-255
