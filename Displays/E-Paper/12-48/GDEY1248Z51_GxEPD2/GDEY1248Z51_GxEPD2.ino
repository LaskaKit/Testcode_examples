/* Display test for Good Display GDP1248RW1 with driver board ESP32-C1258 also from Good Display
 * example from GxEPD2 library is used
 * 
 * Board with display:   LaskaKit ESPink ESP32 e-Paper   https://www.laskakit.cz/good-display-gdp1248rw1-12-48--1304x984-epaper-barevny-displej-wifi/
 * 
