...
//for ESPInk v3.x
GxEPD2_BW < GxEPD2_1330_GDEM133T91, GxEPD2_1330_GDEM133T91::HEIGHT / 2> display(GxEPD2_1330_GDEM133T91(/*CS=5*/ 10, /*DC=*/ 48, /*RST=*/ 45, /*BUSY=*/ 38)); // GDEM133T91 960x680, SSD1677, (FPC-7701 REV.B)
